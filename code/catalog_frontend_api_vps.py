...
# API endpoint - UPDATE THIS WITH YOUR VPS IP
API_URL = "http://159.89.15.19:8000"

# Base image directory
BASE_IMAGE_DIR = "/root/tinyvlm/data/image-description-marketplace-data/flip_data_vlm/flip_data_vlm"
...
def search_by_text(text_query):
    ...
    try:
        ...
        st.error(f"❌ Cannot connect to API. Make sure FastAPI server is running on {API_URL}")
        return []
